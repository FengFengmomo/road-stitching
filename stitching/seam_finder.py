...
class SeamFinder:
    ...
    # 另外三种 seam finder
    # cv.detail.GRAPH_CUT_SEAM_FINDER_BASE_COST_COLOR
    # cv.detail.GRAPH_CUT_SEAM_FINDER_BASE_COST_COLOR_GRAD
    # cv.detail.GraphCutSeamFinderBase_CostType
    ...
    def draw_seam_polygons(panorama, blended_seam_masks, alpha=0.5):
        # 绘制拼接缝多边形
        panoramawithseammasks = add_weighted_image(panorama, blended_seam_masks, alpha)
        return panoramawithseammasks
